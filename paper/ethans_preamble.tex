...
%\newcommand{\uvth}{\boldsymbol{\theta}}
...
\newcommand{\heading}{\bigskip \begin{centering} \quad \includegraphics[width=\textwidth]{gliders.pdf}\end{centering}\bigskip}
\newcommand{\ft}[1]{\bigskip \bigskip \begin{centering} \includegraphics[width=\textwidth]{footers/diaryfooter#1.pdf}\end{centering}\bigskip  }
...
\begin{comment}
\newcommand{\mudkip}{\mathord{\vcenter{\hbox{\includegraphics[scale=.02]{mudkip.png}}}}}

\newcommand{\torchic}{\mathord{\vcenter{\hbox{\includegraphics[scale=.039]{torchic.png}}}}}

\newcommand{\treecko}{\mathord{\vcenter{\hbox{\includegraphics[scale=.079]{treecko.png}}}}}


\newcommand{\charmander}{\mathord{\vcenter{\hbox{\includegraphics[scale=.025]{charmander.png}}}}}
\newcommand{\totodile}{\mathord{\vcenter{\hbox{\includegraphics[scale=.044]{totodile.png}}}}}
\newcommand{\chikorita}{\mathord{\vcenter{\hbox{\includegraphics[scale=.05]{chikorita.png}}}}}

\newcommand{\cyndaquil}{\mathord{\vcenter{\hbox{\includegraphics[scale=.13]{cyndaquil.png}}}}}
\newcommand{\squirtle}{\mathord{\vcenter{\hbox{\includegraphics[scale=.05]{squirtle.png}}}}}
\newcommand{\bulbasaur}{\mathord{\vcenter{\hbox{\includegraphics[scale=.044]{bulbasaur.png}}}}}

\newcommand{\piplup}{\mathord{\vcenter{\hbox{\includegraphics[scale=.079]{piplup.png}}}}}
\newcommand{\chimchar}{\mathord{\vcenter{\hbox{\includegraphics[scale=.085]{chimchar.png}}}}}
\newcommand{\turtwig}{\mathord{\vcenter{\hbox{\includegraphics[scale=.079]{turtwig.png}}}}}

\newcommand{\pikachu}{\mathord{\vcenter{\hbox{\includegraphics[scale=.023]{pikachu.png}}}}}
\end{comment}

\newcommand{\ethan}[1]{ { \color{blue} \footnotesize \textsf{ethan: \textsl{#1}} }}
\newcommand{\yiqiu}[1]{ { \color{red} \footnotesize \textsf{yiqiu: \textsl{#1}} }}
\newcommand{\xiao}[1]{ { \color{green} \footnotesize \textsf{xiao: \textsl{#1}} }}
...
\usepackage{pifont}
\usepackage[normalem]{ulem} % normalem: don't let ulem turn \emph into (non-breaking) underlines; keeps \uline/\sout available explicitly
